...
/**
 * The base model implementation for the Story service. Represents a row in the &quot;WEAL_Story&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StoryModelImpl extends BaseModelImpl<Story> implements StoryModel {
	 ...
	 */
	public static final String TABLE_NAME = "WEAL_Story";
	...
	public static final String TABLE_SQL_CREATE = "create table WEAL_Story (story_Id LONG not null primary key,final_Story VARCHAR(75) null,is_Good_Enough_For_Marketing BOOLEAN,is_Good_Enough_For_Final_Story BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table WEAL_Story";
	public static final String ORDER_BY_JPQL = " ORDER BY story.story_Id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY WEAL_Story.story_Id ASC";

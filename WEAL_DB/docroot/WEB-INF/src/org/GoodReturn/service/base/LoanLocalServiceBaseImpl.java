...
import org.GoodReturn.service.LoanLocalService;
import org.GoodReturn.service.LoanService;
...
import org.GoodReturn.service.persistence.LoanPersistence;
...
/**
 * The base implementation of the loan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.GoodReturn.service.impl.LoanLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
...
public abstract class LoanLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.GoodReturn.service.LoanLocalServiceUtil} to access the loan local service.
	 */
	...
	public Loan addLoan(Loan loan) throws SystemException {
		...
		return loanPersistence.update(loan, false);
	}
	 ...
	 * @return the new loan
	 */
	public Loan createLoan(long loan_Id) {
		return loanPersistence.create(loan_Id);
	}
	...
	public Loan deleteLoan(long loan_Id)
		...
		return loanPersistence.remove(loan_Id);
	}
	...
	public Loan fetchLoan(long loan_Id) throws SystemException {
		return loanPersistence.fetchByPrimaryKey(loan_Id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Loan getLoan(long loan_Id) throws PortalException, SystemException {
		return loanPersistence.findByPrimaryKey(loan_Id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Loan updateLoan(Loan loan, boolean merge) throws SystemException {
		loan.setNew(false);

		return loanPersistence.update(loan, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.GoodReturn.model.Loan",
			loanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.GoodReturn.model.Loan");
	}
	...
	@BeanReference(type = LoanService.class)

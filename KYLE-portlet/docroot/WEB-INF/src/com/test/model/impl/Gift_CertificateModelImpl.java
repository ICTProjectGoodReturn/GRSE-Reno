...
import com.test.model.Gift_CertificateModel;
import com.test.model.Gift_CertificateSoap;
...
/**
 * The base model implementation for the Gift_Certificate service. Represents a row in the &quot;KYLE_Gift_Certificate&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.model.Gift_CertificateModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link Gift_CertificateImpl}.
 * </p>
 *
 * @author gilaa004
 * @see Gift_CertificateImpl
 * @see com.test.model.Gift_Certificate
 * @see com.test.model.Gift_CertificateModel
 * @generated
 */
@JSON(strict = true)
public class Gift_CertificateModelImpl extends BaseModelImpl<Gift_Certificate>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a gift_ certificate model instance should use the {@link com.test.model.Gift_Certificate} interface instead.
	 */
	public static final String TABLE_NAME = "KYLE_Gift_Certificate";
	public static final Object[][] TABLE_COLUMNS = {
			{ "certificate_Id", Types.BIGINT },
			{ "certificate_Amount", Types.DOUBLE },
			{ "certificate_Type", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table KYLE_Gift_Certificate (certificate_Id LONG not null primary key,certificate_Amount DOUBLE,certificate_Type VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table KYLE_Gift_Certificate";
	public static final String ORDER_BY_JPQL = " ORDER BY gift_Certificate.certificate_Id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY KYLE_Gift_Certificate.certificate_Id ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.model.Gift_Certificate"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.model.Gift_Certificate"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.test.model.Gift_Certificate"));

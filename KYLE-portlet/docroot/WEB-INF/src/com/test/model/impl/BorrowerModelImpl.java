...
import com.test.model.BorrowerModel;
import com.test.model.BorrowerSoap;
...
/**
 * The base model implementation for the Borrower service. Represents a row in the &quot;KYLE_Borrower&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.model.BorrowerModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link BorrowerImpl}.
 * </p>
 *
 * @author gilaa004
 * @see BorrowerImpl
 * @see com.test.model.Borrower
 * @see com.test.model.BorrowerModel
 * @generated
 */
@JSON(strict = true)
public class BorrowerModelImpl extends BaseModelImpl<Borrower>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a borrower model instance should use the {@link com.test.model.Borrower} interface instead.
	 */
	public static final String TABLE_NAME = "KYLE_Borrower";
	...
	public static final String TABLE_SQL_CREATE = "create table KYLE_Borrower (abacus_Borrower_Id LONG not null primary key,write_Off_Date DATE null,phone LONG,wait_Time LONG,country VARCHAR(75) null,amount_Needed DOUBLE,amount_Needed_AUD DOUBLE,type_Of_Person VARCHAR(75) null,village VARCHAR(75) null,district VARCHAR(75) null,pdf_Link VARCHAR(75) null,currency_ DOUBLE,date_Applied DATE null)";
	public static final String TABLE_SQL_DROP = "drop table KYLE_Borrower";
	public static final String ORDER_BY_JPQL = " ORDER BY borrower.amount_Needed ASC";
	public static final String ORDER_BY_SQL = " ORDER BY KYLE_Borrower.amount_Needed ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.model.Borrower"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.model.Borrower"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.test.model.Borrower"));

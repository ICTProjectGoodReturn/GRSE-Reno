...
import com.test.model.TeamLenderLoanModel;
import com.test.model.TeamLenderLoanSoap;
...
/**
 * The base model implementation for the TeamLenderLoan service. Represents a row in the &quot;KYLE_TeamLenderLoan&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.model.TeamLenderLoanModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TeamLenderLoanImpl}.
 * </p>
 *
 * @author gilaa004
 * @see TeamLenderLoanImpl
 * @see com.test.model.TeamLenderLoan
 * @see com.test.model.TeamLenderLoanModel
 * @generated
 */
@JSON(strict = true)
public class TeamLenderLoanModelImpl extends BaseModelImpl<TeamLenderLoan>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a team lender loan model instance should use the {@link com.test.model.TeamLenderLoan} interface instead.
	 */
	public static final String TABLE_NAME = "KYLE_TeamLenderLoan";
	public static final Object[][] TABLE_COLUMNS = {
			{ "account_Id", Types.BIGINT }
		};
	public static final String TABLE_SQL_CREATE = "create table KYLE_TeamLenderLoan (account_Id LONG not null primary key)";
	public static final String TABLE_SQL_DROP = "drop table KYLE_TeamLenderLoan";
	public static final String ORDER_BY_JPQL = " ORDER BY teamLenderLoan.account_Id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY KYLE_TeamLenderLoan.account_Id ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.model.TeamLenderLoan"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.model.TeamLenderLoan"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.test.model.TeamLenderLoan"));

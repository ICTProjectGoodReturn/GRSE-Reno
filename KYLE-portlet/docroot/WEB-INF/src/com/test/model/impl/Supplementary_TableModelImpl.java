...
import com.test.model.Supplementary_TableModel;
import com.test.model.Supplementary_TableSoap;
...
/**
 * The base model implementation for the Supplementary_Table service. Represents a row in the &quot;KYLE_Supplementary_Table&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.test.model.Supplementary_TableModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link Supplementary_TableImpl}.
 * </p>
 *
 * @author gilaa004
 * @see Supplementary_TableImpl
 * @see com.test.model.Supplementary_Table
 * @see com.test.model.Supplementary_TableModel
 * @generated
 */
@JSON(strict = true)
public class Supplementary_TableModelImpl extends BaseModelImpl<Supplementary_Table>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a supplementary_ table model instance should use the {@link com.test.model.Supplementary_Table} interface instead.
	 */
	public static final String TABLE_NAME = "KYLE_Supplementary_Table";
	public static final Object[][] TABLE_COLUMNS = {
			{ "table_Id", Types.BIGINT }
		};
	public static final String TABLE_SQL_CREATE = "create table KYLE_Supplementary_Table (table_Id LONG not null primary key)";
	public static final String TABLE_SQL_DROP = "drop table KYLE_Supplementary_Table";
	public static final String ORDER_BY_JPQL = " ORDER BY supplementary_Table.table_Id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY KYLE_Supplementary_Table.table_Id ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.test.model.Supplementary_Table"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.test.model.Supplementary_Table"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.test.model.Supplementary_Table"));

...
import com.test.NoSuchStoryException;

import com.test.model.Story;
import com.test.model.impl.StoryImpl;
import com.test.model.impl.StoryModelImpl;
...
public class StoryPersistenceImpl extends BasePersistenceImpl<Story>
	...
	@Override
	public Story updateImpl(com.test.model.Story story, boolean merge)
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Story")));

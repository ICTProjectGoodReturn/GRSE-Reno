...
import com.test.NoSuchLenderException;

import com.test.model.Lender;
import com.test.model.impl.LenderImpl;
import com.test.model.impl.LenderModelImpl;
...
public class LenderPersistenceImpl extends BasePersistenceImpl<Lender>
	...
	@Override
	public Lender updateImpl(com.test.model.Lender lender, boolean merge)
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Lender")));
	...
	private static final String _SQL_GETPERSONS = "SELECT {KYLE_Person.*} FROM KYLE_Person INNER JOIN KYLE_Lender ON (KYLE_Lender.lender_Id = KYLE_Person.lender_Id) WHERE (KYLE_Lender.lender_Id = ?)";
	private static final String _SQL_GETPERSONSSIZE = "SELECT COUNT(*) AS COUNT_VALUE FROM KYLE_Person WHERE lender_Id = ?";
	private static final String _SQL_CONTAINSPERSON = "SELECT COUNT(*) AS COUNT_VALUE FROM KYLE_Person WHERE lender_Id = ? AND abacus_Person_Id = ?";

...
import com.test.NoSuchBorrowerException;

import com.test.model.Borrower;
import com.test.model.impl.BorrowerImpl;
import com.test.model.impl.BorrowerModelImpl;
...
public class BorrowerPersistenceImpl extends BasePersistenceImpl<Borrower>
	 ...
	 * @throws com.test.NoSuchBorrowerException if a borrower with the primary key could not be found
	...
	@Override
	public Borrower updateImpl(com.test.model.Borrower borrower, boolean merge)
	...
	/**
	 * Returns the borrower with the primary key or throws a {@link com.test.NoSuchBorrowerException} if it could not be found.
	 *
	 * @param abacus_Borrower_Id the primary key of the borrower
	 * @return the borrower
	 * @throws com.test.NoSuchBorrowerException if a borrower with the primary key could not be found
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<com.test.model.Person> getPersons(long pk)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<com.test.model.Person> getPersons(long pk, int start, int end)
		throws SystemException {
		return getPersons(pk, start, end, null);
	}

	public static final FinderPath FINDER_PATH_GET_PERSONS = new FinderPath(com.test.model.impl.PersonModelImpl.ENTITY_CACHE_ENABLED,
			com.test.model.impl.PersonModelImpl.FINDER_CACHE_ENABLED,
			com.test.model.impl.PersonImpl.class,
			com.test.service.persistence.PersonPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"getPersons",
			new String[] {
	...
	public List<com.test.model.Person> getPersons(long pk, int start, int end,
		...
		List<com.test.model.Person> list = (List<com.test.model.Person>)FinderCacheUtil.getResult(FINDER_PATH_GET_PERSONS,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETPERSONS.concat(com.test.model.impl.PersonModelImpl.ORDER_BY_SQL);
				}

				SQLQuery q = session.createSQLQuery(sql);

				q.addEntity("KYLE_Person", com.test.model.impl.PersonImpl.class);

				QueryPos qPos = QueryPos.getInstance(q);

				qPos.add(pk);

				list = (List<com.test.model.Person>)QueryUtil.list(q,
	...
	public static final FinderPath FINDER_PATH_GET_PERSONS_SIZE = new FinderPath(com.test.model.impl.PersonModelImpl.ENTITY_CACHE_ENABLED,
			com.test.model.impl.PersonModelImpl.FINDER_CACHE_ENABLED,
			com.test.model.impl.PersonImpl.class,
			com.test.service.persistence.PersonPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_CONTAINS_PERSON = new FinderPath(com.test.model.impl.PersonModelImpl.ENTITY_CACHE_ENABLED,
			com.test.model.impl.PersonModelImpl.FINDER_CACHE_ENABLED,
			com.test.model.impl.PersonImpl.class,
			com.test.service.persistence.PersonPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"containsPerson",
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Borrower")));
	...
	private static final String _SQL_GETPERSONS = "SELECT {KYLE_Person.*} FROM KYLE_Person INNER JOIN KYLE_Borrower ON (KYLE_Borrower.abacus_Borrower_Id = KYLE_Person.abacus_Borrower_Id) WHERE (KYLE_Borrower.abacus_Borrower_Id = ?)";
	private static final String _SQL_GETPERSONSSIZE = "SELECT COUNT(*) AS COUNT_VALUE FROM KYLE_Person WHERE abacus_Borrower_Id = ?";
	private static final String _SQL_CONTAINSPERSON = "SELECT COUNT(*) AS COUNT_VALUE FROM KYLE_Person WHERE abacus_Borrower_Id = ? AND abacus_Person_Id = ?";

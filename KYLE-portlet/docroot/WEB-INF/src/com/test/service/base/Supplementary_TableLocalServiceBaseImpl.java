...
/**
 * The base implementation of the supplementary_ table local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.Supplementary_TableLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class Supplementary_TableLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Supplementary_TableLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.Supplementary_TableLocalServiceUtil} to access the supplementary_ table local service.
	 */
	...
	public Supplementary_Table addSupplementary_Table(
		Supplementary_Table supplementary_Table) throws SystemException {
		supplementary_Table.setNew(true);

		return supplementary_TablePersistence.update(supplementary_Table, false);
	}
	 ...
	 */
	public Supplementary_Table createSupplementary_Table(long table_Id) {
		return supplementary_TablePersistence.create(table_Id);
	}
	...
	public Supplementary_Table deleteSupplementary_Table(long table_Id)
		throws PortalException, SystemException {
		return supplementary_TablePersistence.remove(table_Id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Supplementary_Table deleteSupplementary_Table(
		Supplementary_Table supplementary_Table) throws SystemException {
		return supplementary_TablePersistence.remove(supplementary_Table);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Supplementary_Table.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return supplementary_TablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return supplementary_TablePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Supplementary_Table fetchSupplementary_Table(long table_Id)
		throws SystemException {
		return supplementary_TablePersistence.fetchByPrimaryKey(table_Id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Supplementary_Table getSupplementary_Table(long table_Id)
		throws PortalException, SystemException {
		return supplementary_TablePersistence.findByPrimaryKey(table_Id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return supplementary_TablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Supplementary_Table> getSupplementary_Tables(int start, int end)
		throws SystemException {
		return supplementary_TablePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSupplementary_TablesCount() throws SystemException {
		return supplementary_TablePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Supplementary_Table updateSupplementary_Table(
		Supplementary_Table supplementary_Table) throws SystemException {
		return updateSupplementary_Table(supplementary_Table, true);
	}
	...
	public Supplementary_Table updateSupplementary_Table(
		...
		return supplementary_TablePersistence.update(supplementary_Table, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.Supplementary_Table",
			supplementary_TableLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = supplementary_TablePersistence.getDataSource();
	...
	private Supplementary_TableLocalServiceClpInvoker _clpInvoker = new Supplementary_TableLocalServiceClpInvoker();
}
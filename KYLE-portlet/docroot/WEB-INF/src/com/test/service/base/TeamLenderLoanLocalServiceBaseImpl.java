...
/**
 * The base implementation of the team lender loan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.TeamLenderLoanLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class TeamLenderLoanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TeamLenderLoanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.TeamLenderLoanLocalServiceUtil} to access the team lender loan local service.
	 */
	...
	public TeamLenderLoan addTeamLenderLoan(TeamLenderLoan teamLenderLoan)
		throws SystemException {
		teamLenderLoan.setNew(true);

		return teamLenderLoanPersistence.update(teamLenderLoan, false);
	}
	 ...
	 */
	public TeamLenderLoan createTeamLenderLoan(long account_Id) {
		return teamLenderLoanPersistence.create(account_Id);
	}
	...
	public TeamLenderLoan deleteTeamLenderLoan(long account_Id)
		throws PortalException, SystemException {
		return teamLenderLoanPersistence.remove(account_Id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TeamLenderLoan deleteTeamLenderLoan(TeamLenderLoan teamLenderLoan)
		throws SystemException {
		return teamLenderLoanPersistence.remove(teamLenderLoan);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TeamLenderLoan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return teamLenderLoanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return teamLenderLoanPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TeamLenderLoan fetchTeamLenderLoan(long account_Id)
		throws SystemException {
		return teamLenderLoanPersistence.fetchByPrimaryKey(account_Id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TeamLenderLoan getTeamLenderLoan(long account_Id)
		throws PortalException, SystemException {
		return teamLenderLoanPersistence.findByPrimaryKey(account_Id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return teamLenderLoanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TeamLenderLoan> getTeamLenderLoans(int start, int end)
		throws SystemException {
		return teamLenderLoanPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTeamLenderLoansCount() throws SystemException {
		return teamLenderLoanPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TeamLenderLoan updateTeamLenderLoan(TeamLenderLoan teamLenderLoan)
		throws SystemException {
		return updateTeamLenderLoan(teamLenderLoan, true);
	}
	...
	public TeamLenderLoan updateTeamLenderLoan(TeamLenderLoan teamLenderLoan,
		...
		return teamLenderLoanPersistence.update(teamLenderLoan, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.TeamLenderLoan",
			teamLenderLoanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.TeamLenderLoan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = teamLenderLoanPersistence.getDataSource();
	...
	private TeamLenderLoanLocalServiceClpInvoker _clpInvoker = new TeamLenderLoanLocalServiceClpInvoker();
}
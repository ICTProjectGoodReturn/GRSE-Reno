...
/**
 * The base implementation of the story local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.StoryLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class StoryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.StoryLocalServiceUtil} to access the story local service.
	 */
	...
	public Story addStory(Story story) throws SystemException {
		story.setNew(true);

		return storyPersistence.update(story, false);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Story.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return storyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return storyPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return storyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Story> getStories(int start, int end) throws SystemException {
		return storyPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getStoriesCount() throws SystemException {
		return storyPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Story updateStory(Story story) throws SystemException {
		return updateStory(story, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Story updateStory(Story story, boolean merge)
		throws SystemException {
		story.setNew(false);

		return storyPersistence.update(story, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.Story",
			storyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.Story");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = storyPersistence.getDataSource();

...
/**
 * The base implementation of the borrower local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.BorrowerLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
...
public abstract class BorrowerLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.BorrowerLocalServiceUtil} to access the borrower local service.
	 */
	...
	public Borrower addBorrower(Borrower borrower) throws SystemException {
		...
		return borrowerPersistence.update(borrower, false);
	}
	...
	public Borrower updateBorrower(Borrower borrower) throws SystemException {
		return updateBorrower(borrower, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Borrower updateBorrower(Borrower borrower, boolean merge)
		throws SystemException {
		borrower.setNew(false);

		return borrowerPersistence.update(borrower, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.Borrower",
			borrowerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.Borrower");
	}

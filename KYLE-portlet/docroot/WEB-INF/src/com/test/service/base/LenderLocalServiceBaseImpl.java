...
import com.test.service.BorrowerLocalService;
import com.test.service.BorrowerService;
import com.test.service.Gift_CertificateLocalService;
import com.test.service.Gift_CertificateService;
import com.test.service.LenderLocalService;
import com.test.service.LenderService;
import com.test.service.PersonLocalService;
import com.test.service.PersonService;
import com.test.service.StoryLocalService;
import com.test.service.StoryService;
import com.test.service.Supplementary_TableLocalService;
import com.test.service.Supplementary_TableService;
import com.test.service.TeamLenderLoanLocalService;
import com.test.service.TeamLenderLoanService;
import com.test.service.TeamLenderLocalService;
import com.test.service.TeamLenderService;
import com.test.service.TeamLocalService;
import com.test.service.TeamService;
import com.test.service.persistence.BorrowerPersistence;
import com.test.service.persistence.Gift_CertificatePersistence;
import com.test.service.persistence.LenderPersistence;
import com.test.service.persistence.PersonPersistence;
import com.test.service.persistence.StoryPersistence;
import com.test.service.persistence.Supplementary_TablePersistence;
import com.test.service.persistence.TeamLenderLoanPersistence;
import com.test.service.persistence.TeamLenderPersistence;
import com.test.service.persistence.TeamPersistence;
...
/**
 * The base implementation of the lender local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.LenderLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class LenderLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LenderLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.LenderLocalServiceUtil} to access the lender local service.
	 */
	...
	public Lender addLender(Lender lender) throws SystemException {
		lender.setNew(true);

		return lenderPersistence.update(lender, false);
	}
	 ...
	 */
	public Lender createLender(long lender_Id) {
		return lenderPersistence.create(lender_Id);
	}
	...
	public Lender deleteLender(long lender_Id)
		throws PortalException, SystemException {
		return lenderPersistence.remove(lender_Id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Lender deleteLender(Lender lender) throws SystemException {
		return lenderPersistence.remove(lender);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Lender.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return lenderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return lenderPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lenderPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Lender fetchLender(long lender_Id) throws SystemException {
		return lenderPersistence.fetchByPrimaryKey(lender_Id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Lender getLender(long lender_Id)
		throws PortalException, SystemException {
		return lenderPersistence.findByPrimaryKey(lender_Id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lenderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Lender> getLenders(int start, int end)
		throws SystemException {
		return lenderPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLendersCount() throws SystemException {
		return lenderPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Lender updateLender(Lender lender) throws SystemException {
		return updateLender(lender, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Lender updateLender(Lender lender, boolean merge)
		throws SystemException {
		lender.setNew(false);

		return lenderPersistence.update(lender, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.Lender",
			lenderLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.Lender");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lenderPersistence.getDataSource();
	...
	private LenderLocalServiceClpInvoker _clpInvoker = new LenderLocalServiceClpInvoker();
}
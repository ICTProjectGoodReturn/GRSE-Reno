...
public class PersonUtil {
	...
	*/
	public static void cacheResult(com.test.model.Person person) {
	...
	*/
	public static void cacheResult(
		java.util.List<com.test.model.Person> persons) {
	...
	*/
	public static com.test.model.Person create(long abacus_Person_Id) {
	...
	* @throws com.test.NoSuchPersonException if a person with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.Person remove(long abacus_Person_Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchPersonException {
		return getPersistence().remove(abacus_Person_Id);
	}

	public static com.test.model.Person updateImpl(
	...
	/**
	* Returns the person with the primary key or throws a {@link com.test.NoSuchPersonException} if it could not be found.
	*
	* @param abacus_Person_Id the primary key of the person
	* @return the person
	* @throws com.test.NoSuchPersonException if a person with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.Person findByPrimaryKey(long abacus_Person_Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.test.NoSuchPersonException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.test.model.Person fetchByPrimaryKey(long abacus_Person_Id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.model.Person> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.test.model.Person> findAll(int start,
	...
	*/
	...
	public static PersonPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (PersonPersistence)PortletBeanLocatorUtil.locate(com.test.service.ClpSerializer.getServletContextName(),

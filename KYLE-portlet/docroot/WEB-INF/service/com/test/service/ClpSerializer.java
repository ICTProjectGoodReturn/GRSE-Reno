...
import com.test.model.BorrowerClp;
import com.test.model.Gift_CertificateClp;
import com.test.model.LenderClp;
import com.test.model.PersonClp;
import com.test.model.StoryClp;
import com.test.model.Supplementary_TableClp;
import com.test.model.TeamClp;
import com.test.model.TeamLenderClp;
import com.test.model.TeamLenderLoanClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"KYLE-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "KYLE-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.test.model.impl.BorrowerImpl")) {
			return translateOutputBorrower(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.Gift_CertificateImpl")) {
			return translateOutputGift_Certificate(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.LenderImpl")) {
			return translateOutputLender(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.PersonImpl")) {
			return translateOutputPerson(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.StoryImpl")) {
			return translateOutputStory(oldModel);
		}

		if (oldModelClassName.equals(
					"com.test.model.impl.Supplementary_TableImpl")) {
			return translateOutputSupplementary_Table(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.TeamImpl")) {
			return translateOutputTeam(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.TeamLenderImpl")) {
			return translateOutputTeamLender(oldModel);
		}

		if (oldModelClassName.equals("com.test.model.impl.TeamLenderLoanImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.test.NoSuchBorrowerException")) {
			return new com.test.NoSuchBorrowerException();
		}

		if (className.equals("com.test.NoSuchGift_CertificateException")) {
			return new com.test.NoSuchGift_CertificateException();
		}

		if (className.equals("com.test.NoSuchLenderException")) {
			return new com.test.NoSuchLenderException();
		}

		if (className.equals("com.test.NoSuchPersonException")) {
			return new com.test.NoSuchPersonException();
		}

		if (className.equals("com.test.NoSuchStoryException")) {
			return new com.test.NoSuchStoryException();
		}

		if (className.equals("com.test.NoSuchSupplementary_TableException")) {
			return new com.test.NoSuchSupplementary_TableException();
		}

		if (className.equals("com.test.NoSuchTeamException")) {
			return new com.test.NoSuchTeamException();
		}

		if (className.equals("com.test.NoSuchTeamLenderException")) {
			return new com.test.NoSuchTeamLenderException();
		}

		if (className.equals("com.test.NoSuchTeamLenderLoanException")) {
			return new com.test.NoSuchTeamLenderLoanException();
		}

...
create index IX_C5C88238 on GoodReturn_Story (abacus_Borrower_Loan_Id, groupId);
create index IX_9A328429 on GoodReturn_Story (abacus_Borrower_Loan_Id, mfiId);
...
create index IX_F26C3325 on GoodReturn_TempBl (mfiId);
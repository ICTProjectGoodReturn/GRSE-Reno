 ...
 * @author gilaa004
 */
public class TempBlLocalServiceClp implements TempBlLocalService {
	public TempBlLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public org.goodreturn.model.TempBl addTempBl(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(tempBl) });
		}
		catch (Throwable t) {
	...
	public org.goodreturn.model.TempBl updateTempBl(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(tempBl), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

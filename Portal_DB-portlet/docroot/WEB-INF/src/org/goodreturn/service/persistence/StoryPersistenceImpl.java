...
public class StoryPersistenceImpl extends BasePersistenceImpl<Story>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_G = new FinderPath(StoryModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STATUS = new FinderPath(StoryModelImpl.ENTITY_CACHE_ENABLED,
			StoryModelImpl.FINDER_CACHE_ENABLED, StoryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STATUS =
		new FinderPath(StoryModelImpl.ENTITY_CACHE_ENABLED,
			StoryModelImpl.FINDER_CACHE_ENABLED, StoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBystatus",
			new String[] { Integer.class.getName() },
			StoryModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_STATUS = new FinderPath(StoryModelImpl.ENTITY_CACHE_ENABLED,
			StoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Story updateImpl(org.goodreturn.model.Story story, boolean merge)
		...
		if (isNew || !StoryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((storyModelImpl.getColumnBitmask() &
				...
				args = new Object[] { Integer.valueOf(storyModelImpl.getStatus()) };
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Story> findBystatus(int status) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Story> findBystatus(int status, int start, int end)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Story findBystatus_First(int status,
		OrderByComparator orderByComparator)
		throws NoSuchStoryException, SystemException {
		Story story = fetchBystatus_First(status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Story fetchBystatus_First(int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<Story> list = findBystatus(status, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Story findBystatus_Last(int status,
		OrderByComparator orderByComparator)
		throws NoSuchStoryException, SystemException {
		Story story = fetchBystatus_Last(status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Story fetchBystatus_Last(int status,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countBystatus(status);

		List<Story> list = findBystatus(status, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Story[] findBystatus_PrevAndNext(long story_Id, int status,
		OrderByComparator orderByComparator)
		throws NoSuchStoryException, SystemException {
		Story story = findByPrimaryKey(story_Id);
		...
		try {
			...
			array[0] = getBystatus_PrevAndNext(session, story, status,
					orderByComparator, true);

			array[1] = story;

			array[2] = getBystatus_PrevAndNext(session, story, status,
					orderByComparator, false);
	...
	protected Story getBystatus_PrevAndNext(Session session, Story story,
	...
	public void removeBystatus(int status) throws SystemException {
		for (Story story : findBystatus(status)) {
			remove(story);
		}
	}
	...
	private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "story.status = ?";

...
/**
 * The base implementation of the borrower loan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.goodreturn.service.impl.BorrowerLoanLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class BorrowerLoanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BorrowerLoanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.goodreturn.service.BorrowerLoanLocalServiceUtil} to access the borrower loan local service.
	 */
	...
	public BorrowerLoan addBorrowerLoan(BorrowerLoan borrowerLoan)
		throws SystemException {
		borrowerLoan.setNew(true);

		return borrowerLoanPersistence.update(borrowerLoan, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BorrowerLoan deleteBorrowerLoan(BorrowerLoan borrowerLoan)
		throws SystemException {
		return borrowerLoanPersistence.remove(borrowerLoan);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(BorrowerLoan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return borrowerLoanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return borrowerLoanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<BorrowerLoan> getBorrowerLoans(int start, int end)
		throws SystemException {
		return borrowerLoanPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getBorrowerLoansCount() throws SystemException {
		return borrowerLoanPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BorrowerLoan updateBorrowerLoan(BorrowerLoan borrowerLoan)
		throws SystemException {
		return updateBorrowerLoan(borrowerLoan, true);
	}
	...
	public BorrowerLoan updateBorrowerLoan(BorrowerLoan borrowerLoan,
		...
		return borrowerLoanPersistence.update(borrowerLoan, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.goodreturn.model.BorrowerLoan",
			borrowerLoanLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = borrowerLoanPersistence.getDataSource();
	...
	private BorrowerLoanLocalServiceClpInvoker _clpInvoker = new BorrowerLoanLocalServiceClpInvoker();
}
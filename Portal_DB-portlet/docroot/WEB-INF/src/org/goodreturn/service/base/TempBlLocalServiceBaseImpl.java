...
/**
 * The base implementation of the temp bl local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.goodreturn.service.impl.TempBlLocalServiceImpl}.
 * </p>
 *
 * @author gilaa004
 ...
 * @generated
 */
public abstract class TempBlLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TempBlLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.goodreturn.service.TempBlLocalServiceUtil} to access the temp bl local service.
	 */
	...
	public TempBl addTempBl(TempBl tempBl) throws SystemException {
		tempBl.setNew(true);

		return tempBlPersistence.update(tempBl, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TempBl deleteTempBl(TempBl tempBl) throws SystemException {
		return tempBlPersistence.remove(tempBl);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TempBl.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempBlPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return tempBlPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempBlPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempBl> getTempBls(int start, int end)
		throws SystemException {
		return tempBlPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTempBlsCount() throws SystemException {
		return tempBlPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TempBl updateTempBl(TempBl tempBl) throws SystemException {
		return updateTempBl(tempBl, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TempBl updateTempBl(TempBl tempBl, boolean merge)
		throws SystemException {
		tempBl.setNew(false);

		return tempBlPersistence.update(tempBl, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.goodreturn.model.TempBl",
			tempBlLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.goodreturn.model.TempBl");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempBlPersistence.getDataSource();
	...
	private TempBlLocalServiceClpInvoker _clpInvoker = new TempBlLocalServiceClpInvoker();
}